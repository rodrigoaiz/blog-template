...
function rodrigoaiz_register_scripts(){
    wp_enqueue_style('rodrigoaiz-script', get_template_directory_uri() . "/main.js", array(), '1.0', true);
    wp_enqueue_style('rodrigoaiz-bootstrapjs', "https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/js/bootstrap.bundle.min.js", array(), '5.2.0', true);
    wp_enqueue_style('rodrigoaiz-jquery', "https://code.jquery.com/jquery-3.6.0.slim.min.js", array(), '3.6.0', true);
}
